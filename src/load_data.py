...
class Data(object):
    def __init__(self, path, batch_size, maxlen):
        ...
        self.train_data, self.test_data, self.train_dict, self.test_dict, self.train_user_items_dict, self.train_item_users_dict, self.test_user_items_dict, self.test_item_users_dict = self.load_data_set(
        ...
        self.train_temporal_table = self.build_temporal_table(self.maxlen, self.train_user_items_dict,
                                                              self.train_item_users_dict)  # [M+N, S]
        self.test_temporal_table = self.build_temporal_table(self.maxlen, self.test_user_items_dict,
                                                             self.test_item_users_dict)  # [M+N, S]
